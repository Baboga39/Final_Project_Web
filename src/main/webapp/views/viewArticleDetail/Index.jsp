...
<d:detail>
    <jsp:body>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                    <c:if test="${checkPre == false && checkEx== false}">
                    <div class="col-lg-8">
                        <!-- News Detail Start -->
                    ...
                    <c:if test="${checkPre == false && sessionScope.auth== false}">
                        <div class="col-lg-8">
                            <!-- News Detail Start -->
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="${pageContext.request.contextPath}/image/Article/${article.avatar}" style="object-fit: cover;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="message">Comment *</label>
                                            <textarea id="message3" cols="30" rows="5" class="form-control"></textarea>
                                        </div>
                                        <div class="form-group mb-0">
                                            <input type="submit" value="Post a comment"
                                                   class="btn btn-primary font-weight-semi-bold py-2 px-3">
                    ...
                    <c:if test="${checkPre == false && checkEx== true}">
                        <div class="col-lg-8">
                            <!-- News Detail Start -->
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="${pageContext.request.contextPath}/image/Article/${article.avatar}" style="object-fit: cover;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="message">Comment *</label>
                                            <textarea id="message2" cols="30" rows="5" class="form-control"></textarea>
                                        </div>
                                        <div class="form-group mb-0">
                                            <input type="submit" value="Post a comment"
                                                   class="btn btn-primary font-weight-semi-bold py-2 px-3">
                    ...
                    <c:if test="${checkPre == true && checkEx== true}">
                        <div class="col-lg-8">
                            <!-- News Detail Start -->
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="${pageContext.request.contextPath}/image/Article/${article.avatar}" style="object-fit: cover;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="message">Comment *</label>
                                            <textarea id="message1" cols="30" rows="5" class="form-control"></textarea>
                                        </div>
                                        <div class="form-group mb-0">
                                            <input type="submit" value="Post a comment"
                                                   class="btn btn-primary font-weight-semi-bold py-2 px-3">
